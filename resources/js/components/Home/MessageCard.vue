    ...
    <div class="px-8 py-16">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-3 gap-10 py-10">
                <Link v-for="profile in props.profiles" :href="`/profiles/${profile.id}`"
                    class="bg-[var(--primary-brand-500)]/80 hover:scale-101 transition duration-400 ease-in-out rounded-xs block shadow-md h-full">
